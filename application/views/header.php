            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw"></i> <?php echo $this->lang->line("user_profile") ?></a>
                        </li>
                        
                        <li>
                            <a href="tables.html"><i class="fa fa-wrench fa-fw"></i> <?php echo $this->lang->line("configuration") ?></a>
                        </li>
                        <li>
